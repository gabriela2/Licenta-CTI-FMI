...
import { PreventUnsavedChangesForAddFundraiserGuard } from './guards/prevent-unsaved-changes-for-add-fundraiser.guard';
...
const routes: Routes = [
  { path: '', component: HomeComponent },
  {
    ...
    canActivate: [AuthGuard,ConfirmEmailGuard],
    children: [
      ...
      { path: 'add-fundraiser', component: AddFundraiserComponent, canDeactivate:[PreventUnsavedChangesForAddFundraiserGuard] },
