        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripeAccount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StripeConfigurationLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    StripeLinkWasAccessed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExistsLimit = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ads_UnitsOfMeasure_UnitOfMeasureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRatings_Users_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserRatings_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users_X_RoleTypes", x => new { x.UserId, x.RoleTypeId });
                    table.ForeignKey(
                        name: "FK_Users_X_RoleTypes_RoleTypes_RoleTypeId",
                        column: x => x.RoleTypeId,
                        principalTable: "RoleTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_X_RoleTypes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ads_X_DeliveryTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ads_X_DeliveryTypes_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ads_X_DeliveryTypes_DeliveryTypes_DeliveryTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTypeSelected = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AdId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Photos_Fundraisers_FundraiserId",
                        column: x => x.FundraiserId,
                        principalTable: "Fundraisers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ads_X_DeliveryTypes_AdId",
                table: "Ads_X_DeliveryTypes",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_Ads_X_DeliveryTypes_DeliveryTypeId",
                table: "Ads_X_DeliveryTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRatings_ReceiverId",
                table: "UserRatings",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRatings_SenderId",
                table: "UserRatings",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_X_RoleTypes_RoleTypeId",
